...
# -*- coding: utf-8 -*-
#
# Cloud Application API Development and Management Guide documentation build configuration file, created by
...
htmlhelp_basename = 'CloudApplicationAPIDevelopmentandManagementGuidedoc'
